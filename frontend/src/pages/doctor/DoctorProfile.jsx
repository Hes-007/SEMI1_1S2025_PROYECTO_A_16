...
const DoctorProfile = () => {
  ...
  // Cargar perfil del médico al montar el componente
  useEffect(() => {
  ...
  const handleUpdateProfile = async (values) => {
    try {
      ...
      const response = await doctorService.updateProfile(values);
        ...
        <div className="profile-card">
          <div className="profile-header">
            ...
            <div className="profile-info">
              ...
              <p className="profile-specialty">{profile.especialidad.nombre}</p>
            </div>
          </div>
          ...
          <div className="profile-section">
            ...
            <Formik
              initialValues={{
                ...
                direccion_clinica: profile.direccion_clinica || '',
            ...
            >
              {({ isSubmitting }) => (
                <Form className="profile-form">
                  ...
                  <div className="form-group">
                    <label htmlFor="direccion_clinica" className="form-label">Dirección de la Clínica</label>
                    <Field
                      type="text"
          ...
          <div className="profile-section">
            ...
            <div className="profile-info-grid">
              ...
              <div className="profile-info-item">
                ...
                <div className="profile-info-value">{profile.especialidad.nombre}</div>
              </div>
              <div className="profile-info-item">
                <div className="profile-info-label">Número de Colegiado:</div>
                <div className="profile-info-value">{profile.numero_colegiado}</div>
              </div>
              <div className="profile-info-item">
